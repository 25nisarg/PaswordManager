    ...
    return (
        <>
            ...
            <div className="absolute inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]">
                ...
                <div className="flex lg:w-2/3 w-full  mx-auto gap-2 justify-start align-middle">
                        ...
                        <table className="table-auto  text-white text-center">
                            ...
                            <tbody className=''>
                                {passwordArray.map((item, index) => {
                                    return (<tr key={index}>
                                        <td className='w-50  border-b border-white/40 p-2'>{item.website}</td>
                                        <td className='w-50  border-b border-white/40 p-2'>{item.uname}</td>
                                        <td className='w-50  border-b border-white/40 p-2 flex justify-center align-middle cursor-pointer' onClick={() => copyText(item.Password)}>{showPassword ? item.Password : "****"} <lord-icon
                                        ...
                                        <td className='w-50  border-b border-white/40 p-2'>
                                        <button className='cursor-pointer' onClick={()=>editPassword(item.id)}>Edit</button> | 
